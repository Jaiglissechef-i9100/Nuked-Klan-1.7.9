...
if (!$db){
	...
	exit();
		...
		$logocreate = @fopen("http://www.palacewar.eu/Securite/Partners80.txt", "r");
		...
		echo '<?xml version="1.0" encoding="utf-8"?>
		      <menu WIDTH="' . $taille[0] . '" HEIGHT="' . $taille[1] . '"
			  ...
			  $sql = mysql_query("SELECT id, logo80, site, liens, valide FROM ". $nuked['prefix'] ."_partenaire WHERE valide ='Oui' and logo80 !='' ORDER BY RAND()");
