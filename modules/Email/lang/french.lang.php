...
define("_MESSSEND","Mail envoyé avec succès.");
define("_MESSSNOEND","Mail non envoyé, vérifier que la fonction mail() est active sur votre hébergeur.");
...
define("_NIVOMEMBERS","Membres du site (Niveau ");
